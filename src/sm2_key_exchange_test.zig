...
test "SM2 key exchange multiple rounds" {
    ...
    var bob_ctx1 = key_exchange.KeyExchangeContext.init(.responder, bob_private, bob_public, bob_id);
    ...
    var bob_ctx2 = key_exchange.KeyExchangeContext.init(.responder, bob_private, bob_public, bob_id);
